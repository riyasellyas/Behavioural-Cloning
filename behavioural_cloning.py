...
Original file is located at
    https://colab.research.google.com/drive/1rPbV1uGWpr-nQSp3zWq3AyE8QzRqem-2
"""

!git clone https://github.com/riyasellyas/track
...
def img_radom_brightness(image):
...
image = image_paths[random.randint(0, 1000)]
original_image = mpimg.imread(image)
brightness_altered_image = img_radom_brightness(original_image)
...
radom_index = random.randint(0, 1000)
image = image_paths[radom_index]
steering_angle = steerings[radom_index]
...
def random_augment(image, steering_angle):
  ...
  if np.random.rand() < 0.5:
    image = pan(image)
  if np.random.rand() < 0.5:
    image = img_radom_brightness(image)
  if np.random.rand() < 0.5:
